...
from opentools.chain.linker.llm_pass import LLMLinkPassResult, llm_link_pass_async
...
async def _seed_candidate_edge(engagement_store, chain_store):
    ...
    # protocol before calling llm_link_pass_async.
    a = Finding(
...
async def test_llm_pass_promotes_related_high_confidence(async_chain_stores):
    engagement_store, chain_store, _ = async_chain_stores
    await _seed_candidate_edge(engagement_store, chain_store)
...
async def test_llm_pass_rejects_unrelated(async_chain_stores):
    engagement_store, chain_store, _ = async_chain_stores
    await _seed_candidate_edge(engagement_store, chain_store)
    await _demote_all_to_candidate(chain_store)
...
async def test_llm_pass_cache_hit(async_chain_stores):
    engagement_store, chain_store, _ = async_chain_stores
    await _seed_candidate_edge(engagement_store, chain_store)
    await _demote_all_to_candidate(chain_store)
...
async def test_llm_link_pass_async_promotes_via_await(async_chain_stores):
